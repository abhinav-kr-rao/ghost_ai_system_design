We need base the chrome components that frame every editor screen - the top navbar and the left sidebar shell. These will be resused and extended in every chapter that follows.
