Prisma is already installed. Add the prisma data models, Prisma client singleton, and first migration.


## Models

Create `prsima/models/project.prisma`
...
- `canvasJsonBlob` for future canvas blob storage
- timestamps
...
- if it starts with `prisma+postgres://`, use Accelarate        
